...
var len__5766__auto___12753 = arguments.length;
var i__5767__auto___12754 = (0);
while(true){
if((i__5767__auto___12754 < len__5766__auto___12753)){
args__5772__auto__.push((arguments[i__5767__auto___12754]));

var G__12755 = (i__5767__auto___12754 + (1));
i__5767__auto___12754 = G__12755;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq12711){
...
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12712,G__12713,seq12711__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__12736_SHARP_){
return (!((cljs.core.meta(p1__12736_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12738__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e12739){var _e__12016__auto__ = e12739;
return false;
}})();
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
...
}catch (e12741){var _e__12016__auto__ = e12741;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__12744 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__12745 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__12745);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12747__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__12744);
}});
...
var temp__5802__auto___12775 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___12775)){
var managed_print_level_12776 = temp__5802__auto___12775;
var _STAR_print_level_STAR__orig_val__12749_12777 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__12750_12778 = managed_print_level_12776;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__12750_12778);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__12748_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__12748_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__12749_12777);
}} else {
job_fn();
}
