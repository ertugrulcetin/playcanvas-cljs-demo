...
var G__24032 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__24032;
continue;
} else {
var G__24033 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__24033;
continue;
}
} else {
var G__24034 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__24034;
continue;
}
}
...
var G__23990 = zloc;
var G__23991 = (function (){var G__23992 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__23993 = zloc;
var G__23993__$1 = (((G__23993 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__23993) : rewrite_clj.zip.node.call(null,G__23993)));
if((G__23993__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__23993__$1) : zprint.zutil.edn_STAR_.call(null,G__23993__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__23992) : rewrite_clj.zip.root.call(null,G__23992));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__23990,G__23991) : rewrite_clj.zip.replace.call(null,G__23990,G__23991));
});
/**
...
var G__24047 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__24047;
continue;
}
break;
...
var G__24048 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__24049 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__24048;
out = G__24049;
continue;
} else {
...
var G__24056 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__24057 = cljs.core.next(new_loc);
var G__24058 = replaced_loc;
nloc = G__24056;
new_loc = G__24057;
last_loc = G__24058;
continue;
...
return zprint.rewrite.sort_val((function (){var G__24025 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__24025) : rewrite_clj.zip.down.call(null,G__24025));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__24026_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__24026_SHARP_) : rewrite_clj.zip.tag.call(null,p1__24026_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__24026_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__24026_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
