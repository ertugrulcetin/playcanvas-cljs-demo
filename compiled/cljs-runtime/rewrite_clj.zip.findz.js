...
var len__5766__auto___23274 = arguments.length;
var i__5767__auto___23275 = (0);
while(true){
if((i__5767__auto___23275 < len__5766__auto___23274)){
args__5772__auto__.push((arguments[i__5767__auto___23275]));

var G__23278 = (i__5767__auto___23275 + (1));
i__5767__auto___23275 = G__23278;
continue;
} else {
}
break;
...
(rewrite_clj.zip.findz.tag_predicate.cljs$core$IFn$_invoke$arity$variadic = (function (t,p__23184){
var vec__23185 = p__23184;
var additional = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23185,(0),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__23181_SHARP_),t);
});
}
}));
...
/** @this {Function} */
(rewrite_clj.zip.findz.tag_predicate.cljs$lang$applyTo = (function (seq23182){
var G__23183 = cljs.core.first(seq23182);
var seq23182__$1 = cljs.core.next(seq23182);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23183,seq23182__$1);
}));

rewrite_clj.zip.findz.in_range_QMARK_ = (function rewrite_clj$zip$findz$in_range_QMARK_(p__23198,p__23199){
var map__23200 = p__23198;
var map__23200__$1 = cljs.core.__destructure_map(map__23200);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23200__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23200__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var end_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23200__$1,new cljs.core.Keyword(null,"end-row","end-row",-545103581));
var end_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23200__$1,new cljs.core.Keyword(null,"end-col","end-col",-724155879));
var map__23201 = p__23199;
var map__23201__$1 = cljs.core.__destructure_map(map__23201);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23201__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var c = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23201__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
...
return cljs.core.last(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__23223_SHARP_){
var and__5041__auto__ = (p_QMARK_.cljs$core$IFn$_invoke$arity$1 ? p_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__23223_SHARP_) : p_QMARK_.call(null,p1__23223_SHARP_));
if(cljs.core.truth_(and__5041__auto__)){
return rewrite_clj.zip.findz.in_range_QMARK_(cljs.core.meta(clojure.zip.node(p1__23223_SHARP_)),pos);
} else {
return and__5041__auto__;
}
...
var G__23228 = zloc;
var G__23228__$1 = (((G__23228 == null))?null:(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__23228) : f.call(null,G__23228)));
if((G__23228__$1 == null)){
return null;
} else {
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(G__23228__$1,f,p_QMARK_);
}
}));
...
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(zloc,f,(function (p1__23229_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__23229_SHARP_),t);
}));
}));
...
return rewrite_clj.zip.findz.find_last_by_pos.cljs$core$IFn$_invoke$arity$3(zloc,pos,(function (p1__23238_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__23238_SHARP_),t);
}));
});
/**
...
var p_QMARK_ = ((cljs.core.set_QMARK_(v))?cljs.core.comp.cljs$core$IFn$_invoke$arity$2(v,rewrite_clj.zip.base.sexpr):(function (p1__23264_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.sexpr(p1__23264_SHARP_),v);
}));
