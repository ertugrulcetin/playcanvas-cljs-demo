...
if((c === "\n")){
var G__22896 = escape_QMARK_;
var G__22897 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__22896;
lines = G__22897;
continue;
} else {
buf.append(c);

var G__22898 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__22899 = lines;
escape_QMARK_ = G__22898;
lines = G__22899;
continue;
...
var G__22891 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__22891) : rewrite_clj.node.string_node.call(null,G__22891));
});
...
var G__22892 = cljs.core.re_pattern(regex);
var G__22893 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__22892,G__22893) : rewrite_clj.node.token_node.call(null,G__22892,G__22893));
});
