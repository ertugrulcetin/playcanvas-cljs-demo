...
var i_27956 = (0);
while(true){
if((i_27956 < arr.length)){
(arr[i_27956] = null);

var G__27958 = (i_27956 + (1));
i_27956 = G__27958;
continue;
} else {
}
...
var i_27966 = (self__.level + (1));
while(true){
if((i_27966 <= (new_level + (1)))){
(update[i_27966] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_27968 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_27968[i]));
} else {
x__$2.forward.push((((i < links_27968.length))?(links_27968[i]):null));
}

if((i < links_27968.length)){
(links_27968[i] = x__$2);
} else {
links_27968.push(x__$2);
}
...
var i_27970 = (0);
while(true){
if((i_27970 <= self__.level)){
var links_27971 = (update[i_27970]).forward;
if((x__$1 === (((i_27970 < links_27971.length))?(links_27971[i_27970]):null))){
(links_27971[i_27970] = (x__$1.forward[i_27970]));

var G__27972 = (i_27970 + (1));
i_27970 = G__27972;
continue;
} else {
var G__27974 = (i_27970 + (1));
i_27970 = G__27974;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__27986 = nx;
var G__27987 = (level__$1 - (1));
x = G__27986;
level__$1 = G__27987;
continue;
} else {
var G__27988 = x;
var G__27989 = (level__$1 - (1));
x = G__27988;
level__$1 = G__27989;
continue;
}
