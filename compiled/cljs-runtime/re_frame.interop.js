...
return [(function (){var pred__19727 = cljs.core.instance_QMARK_;
var expr__19728 = reactive_val;
if(cljs.core.truth_((pred__19727.cljs$core$IFn$_invoke$arity$2 ? pred__19727.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__19728) : pred__19727.call(null,reagent.ratom.RAtom,expr__19728)))){
return "ra";
} else {
if(cljs.core.truth_((pred__19727.cljs$core$IFn$_invoke$arity$2 ? pred__19727.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__19728) : pred__19727.call(null,reagent.ratom.RCursor,expr__19728)))){
return "rc";
} else {
if(cljs.core.truth_((pred__19727.cljs$core$IFn$_invoke$arity$2 ? pred__19727.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__19728) : pred__19727.call(null,reagent.ratom.Reaction,expr__19728)))){
return "rx";
} else {
if(cljs.core.truth_((pred__19727.cljs$core$IFn$_invoke$arity$2 ? pred__19727.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__19728) : pred__19727.call(null,reagent.ratom.Track,expr__19728)))){
return "tr";
} else {
return "other";
}
