...
var syms = (function (){var iter__5520__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__22331(s__22332){
return (new cljs.core.LazySeq(null,(function (){
var s__22332__$1 = s__22332;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__22332__$1);
if(temp__5804__auto__){
var s__22332__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__22332__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__22332__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__22334 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__22333 = (0);
while(true){
if((i__22333 < size__5519__auto__)){
var i = cljs.core._nth(c__5518__auto__,i__22333);
...
cljs.core.chunk_append(b__22334,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__22388 = (i__22333 + (1));
i__22333 = G__22388;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22334),rewrite_clj$node$fn$fn_walk_$_iter__22331(cljs.core.chunk_rest(s__22332__$2)));
} else {
...
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__22331(cljs.core.rest(s__22332__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__22330_SHARP_){
var or__5043__auto__ = rewrite_clj.node.fn.symbol__GT_gensym(syms,vararg_QMARK_,max_n,p1__22330_SHARP_);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5342__auto__,k22342,else__5343__auto__){
var self__ = this;
var this__5342__auto____$1 = this;
var G__22351 = k22342;
var G__22351__$1 = (((G__22351 instanceof cljs.core.Keyword))?G__22351.fqn:null);
switch (G__22351__$1) {
case "children":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k22342,else__5343__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5363__auto__,p__22354){
var vec__22355 = p__22354;
var k__5364__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22355,(0),null);
var v__5365__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22355,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__22341){
var self__ = this;
var G__22341__$1 = this;
return (new cljs.core.RecordIter((0),G__22341__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this22343,other22344){
var self__ = this;
var this22343__$1 = this;
return (((!((other22344 == null)))) && ((((this22343__$1.constructor === other22344.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this22343__$1.children,other22344.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this22343__$1.__extmap,other22344.__extmap)))))));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5347__auto__,k22342){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k22342);

}
}));

(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5348__auto__,k__5349__auto__,G__22341){
var self__ = this;
var this__5348__auto____$1 = this;
var pred__22374 = cljs.core.keyword_identical_QMARK_;
var expr__22375 = k__5349__auto__;
if(cljs.core.truth_((pred__22374.cljs$core$IFn$_invoke$arity$2 ? pred__22374.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__22375) : pred__22374.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__22375)))){
return (new rewrite_clj.node.fn.FnNode(G__22341,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5349__auto__,G__22341),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5339__auto__,G__22341){
var self__ = this;
var this__5339__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__22341,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__22345){
var extmap__5382__auto__ = (function (){var G__22381 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__22345,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__22345)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__22381);
} else {
return G__22381;
}
})();
return (new rewrite_clj.node.fn.FnNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__22345),null,cljs.core.not_empty(extmap__5382__auto__),null));
});
