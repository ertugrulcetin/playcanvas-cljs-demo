...
var vec__25714 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__25717 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25717,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25717,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25714,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25714,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__25720){
var vec__25721 = p__25720;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25721,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25721,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25724,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25724,(1),null);
...
var vec__25739 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25739,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25739,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25739,(2),null);
var vec__25742 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25742,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25742,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25742,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__25749){
var vec__25750 = p__25749;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25750,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25750,(1),null);
...
var vec__25758 = tuple;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25758,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25758,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25758,(2),null);
...
var vec__25765 = cljs.core.first(style_vec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25765,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25765,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25765,(2),null);
var tuple = vec__25765;
...
var G__25871 = cljs.core.next(style_vec);
var G__25872 = ends_w_blanks_QMARK_;
var G__25873 = tuple;
var G__25874 = (cljs.core.truth_(add_previous_to_out_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,previous_tuple):out);
style_vec = G__25871;
previous_ends_w_blanks_QMARK_ = G__25872;
previous_tuple = G__25873;
out = G__25874;
continue;
}
break;
...
var len__5766__auto___25875 = arguments.length;
var i__5767__auto___25877 = (0);
while(true){
if((i__5767__auto___25877 < len__5766__auto___25875)){
args__5772__auto__.push((arguments[i__5767__auto___25877]));

var G__25878 = (i__5767__auto___25877 + (1));
i__5767__auto___25877 = G__25878;
continue;
} else {
}
break;
...
var vec__25771 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25771,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25771,(1),null);
...
var result = (function (){var G__25774 = zprint.core.parse_string_all_options(rest_options);
var G__25775 = zprint.core.zprint_str_internal;
var G__25776 = ":parse-string-all? call";
var G__25777 = (function (){var G__25778 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__25778) : zprint.zutil.edn_STAR_.call(null,G__25778));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__25774,G__25775,G__25776,G__25777) : zprint.core.process_multiple_forms.call(null,G__25774,G__25775,G__25776,G__25777));
})();
if(cljs.core.truth_(new cljs.core.Keyword(null,"dbg?","dbg?",1845730771).cljs$core$IFn$_invoke$arity$1(rest_options))){
...
var vec__25779 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25779,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25779,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq25768){
...
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25769,G__25770,seq25768__$2);
}));
...
var args__5772__auto__ = [];
var len__5766__auto___25887 = arguments.length;
var i__5767__auto___25888 = (0);
while(true){
if((i__5767__auto___25888 < len__5766__auto___25887)){
args__5772__auto__.push((arguments[i__5767__auto___25888]));

var G__25889 = (i__5767__auto___25888 + (1));
i__5767__auto___25888 = G__25889;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq25784){
var G__25785 = cljs.core.first(seq25784);
var seq25784__$1 = cljs.core.next(seq25784);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25785,seq25784__$1);
}));
...
var args__5772__auto__ = [];
var len__5766__auto___25890 = arguments.length;
var i__5767__auto___25891 = (0);
while(true){
if((i__5767__auto___25891 < len__5766__auto___25890)){
args__5772__auto__.push((arguments[i__5767__auto___25891]));

var G__25892 = (i__5767__auto___25891 + (1));
i__5767__auto___25891 = G__25892;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq25786){
var G__25787 = cljs.core.first(seq25786);
var seq25786__$1 = cljs.core.next(seq25786);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25787,seq25786__$1);
}));
...
var args__5772__auto__ = [];
var len__5766__auto___25893 = arguments.length;
var i__5767__auto___25894 = (0);
while(true){
if((i__5767__auto___25894 < len__5766__auto___25893)){
args__5772__auto__.push((arguments[i__5767__auto___25894]));

var G__25895 = (i__5767__auto___25894 + (1));
i__5767__auto___25894 = G__25895;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq25790){
var G__25791 = cljs.core.first(seq25790);
var seq25790__$1 = cljs.core.next(seq25790);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25791,seq25790__$1);
}));
...
var args__5772__auto__ = [];
var len__5766__auto___25896 = arguments.length;
var i__5767__auto___25897 = (0);
while(true){
if((i__5767__auto___25897 < len__5766__auto___25896)){
args__5772__auto__.push((arguments[i__5767__auto___25897]));

var G__25898 = (i__5767__auto___25897 + (1));
i__5767__auto___25897 = G__25898;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq25792){
var G__25793 = cljs.core.first(seq25792);
var seq25792__$1 = cljs.core.next(seq25792);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25793,seq25792__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__25802,form){
var vec__25803 = p__25802;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25803,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25803,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25803,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25803,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__25806 = (cljs.core.truth_((function (){var and__5041__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__5041__auto__)){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25806,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25806,(1),null);
...
var G__25910 = cljs.core.next(sos);
var G__25911 = comment_QMARK_;
var G__25912 = (function (){var or__5043__auto__ = (!(empty_string_QMARK_));
if(or__5043__auto__){
return or__5043__auto__;
} else {
...
var G__25913 = ((empty_string_QMARK_)?out:((cljs.core.not(start_interpolating_QMARK_))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,s):(cljs.core.truth_(previous_comment_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,"\n"),s):cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,interpose_str),s)
)));
sos = G__25910;
previous_comment_QMARK_ = G__25911;
start_interpolating_QMARK_ = G__25912;
out = G__25913;
continue;
}
break;
...
try{var vec__25823 = zprint.core.remove_shebang(file_str);
var shebang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25823,(0),null);
var file_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25823,(1),null);
...
var vec__25826 = (cljs.core.truth_((function (){var or__5043__auto__ = range_start__$1;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return range_end__$1;
...
var actual_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25826,(0),null);
var actual_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25826,(1),null);
...
var vec__25829 = (cljs.core.truth_((function (){var and__5041__auto__ = actual_start;
if(cljs.core.truth_(and__5041__auto__)){
return actual_end;
} else {
return and__5041__auto__;
...
var before_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25829,(0),null);
var range = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25829,(1),null);
var after_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25829,(2),null);
...
var forms = (function (){var G__25838 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__25838) : zprint.zutil.edn_STAR_.call(null,G__25838));
})();
