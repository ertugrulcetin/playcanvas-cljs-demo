...
var G__19576 = o;
reagent.impl.template.goog$module$goog$object.set(G__19576,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__19604__i < G__19604__a.length) {G__19604__a[G__19604__i] = arguments[G__19604__i + 0]; ++G__19604__i;}
  args = new cljs.core.IndexedSeq(G__19604__a,0,null);
} 
...
var args = cljs.core.seq(arglist__19605);
...
var G__19577 = o;
reagent.impl.template.goog$module$goog$object.set(G__19577,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__19578 = props;
var G__19578__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__19578,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__19578);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__19578__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5043__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__19579 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__19579,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__19579;
}
})(),id_class);
...
var G__19580 = (cljs.core.count(argv) - first_child);
switch (G__19580) {
case (0):
...
var vec__19581 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19581,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19581,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19581,(2),null);
...
var temp__5808__auto___19615 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___19615 == null)){
} else {
var key_19617 = temp__5808__auto___19615;
(jsprops.key = key_19617);
}
...
var temp__5808__auto___19618 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___19618 == null)){
} else {
var key_19619 = temp__5808__auto___19618;
(jsprops.key = key_19619);
}
...
var temp__5808__auto___19621 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___19621 == null)){
} else {
var key_19622 = temp__5808__auto___19621;
(jsprops.key = key_19622);
}
...
var temp__5808__auto___19628 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___19628 == null)){
} else {
var key_19630 = temp__5808__auto___19628;
(jsprops.key = key_19630);
}
...
var temp__5808__auto___19633 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___19633 == null)){
} else {
var key_19634 = temp__5808__auto___19633;
(jsprops.key = key_19634);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__19584_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__19584_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__19585 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19585,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19585,(1),null);
...
break;
default:
var G__19641 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__19642 = compiler;
v = G__19641;
compiler = G__19642;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template19600 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template19600 = (function (opts,id,fn_to_element,parse_fn,meta19601){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template19600.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_19602,meta19601__$1){
var self__ = this;
var _19602__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template19600(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta19601__$1));
}));

(reagent.impl.template.t_reagent$impl$template19600.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_19602){
var self__ = this;
var _19602__$1 = this;
return self__.meta19601;
}));

(reagent.impl.template.t_reagent$impl$template19600.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template19600.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template19600.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template19600.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template19600.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template19600.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta19601","meta19601",-1257652227,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template19600.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template19600.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template19600");

(reagent.impl.template.t_reagent$impl$template19600.cljs$lang$ctorPrWriter = (function (this__5327__auto__,writer__5328__auto__,opt__5329__auto__){
return cljs.core._write(writer__5328__auto__,"reagent.impl.template/t_reagent$impl$template19600");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template19600.
 */
reagent.impl.template.__GT_t_reagent$impl$template19600 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template19600(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta19601){
return (new reagent.impl.template.t_reagent$impl$template19600(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta19601));
});

}

return (new reagent.impl.template.t_reagent$impl$template19600(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
