...
var len__5766__auto___14201 = arguments.length;
var i__5767__auto___14202 = (0);
while(true){
if((i__5767__auto___14202 < len__5766__auto___14201)){
args__5772__auto__.push((arguments[i__5767__auto___14202]));

var G__14204 = (i__5767__auto___14202 + (1));
i__5767__auto___14202 = G__14204;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__14087_14205 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__14088_14206 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__14089_14207 = true;
var _STAR_print_fn_STAR__temp_val__14090_14208 = (function (x__5688__auto__){
return sb__5687__auto__.append(x__5688__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__14089_14207);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__14090_14208);

try{var _STAR_print_level_STAR__orig_val__14091_14209 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__14092_14210 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__14092_14210);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__14091_14209);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__14088_14206);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__14087_14205);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq14083){
var self__5752__auto__ = this;
return self__5752__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq14083));
}));
...
var new_formatters = current_formatters.filter((function (p1__14120_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__14120_SHARP_)));
}));
...
var G__14126_14231 = f;
var target__12010__auto___14232 = G__14126_14231;
if(cljs.core.truth_(target__12010__auto___14232)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14126_14231)].join(''),"\n","target__12010__auto__"].join('')));
}

(target__12010__auto___14232["toString"] = (function (){
...
var G__14128_14234 = "%c%s";
var G__14129_14235 = "color:transparent";
var G__14130_14236 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__14128_14234,G__14129_14235,G__14130_14236) : f.call(null,G__14128_14234,G__14129_14235,G__14130_14236));
...
var args__5772__auto__ = [];
var len__5766__auto___14243 = arguments.length;
var i__5767__auto___14248 = (0);
while(true){
if((i__5767__auto___14248 < len__5766__auto___14243)){
args__5772__auto__.push((arguments[i__5767__auto___14248]));

var G__14249 = (i__5767__auto___14248 + (1));
i__5767__auto___14248 = G__14249;
continue;
} else {
}
break;
...
var vec__14153 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14153,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14153,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__14255__delegate = function (add_fmt,add_args){
...
var G__14255 = function (add_fmt,var_args){
var add_args = null;
...
while (G__14256__i < G__14256__a.length) {G__14256__a[G__14256__i] = arguments[G__14256__i + 1]; ++G__14256__i;}
  add_args = new cljs.core.IndexedSeq(G__14256__a,0,null);
} 
return G__14255__delegate.call(this,add_fmt,add_args);};
G__14255.cljs$lang$maxFixedArity = 1;
G__14255.cljs$lang$applyTo = (function (arglist__14257){
var add_fmt = cljs.core.first(arglist__14257);
var add_args = cljs.core.rest(arglist__14257);
return G__14255__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq14146){
...
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14147,G__14148,G__14149,seq14146__$3);
}));
...
var seq__14165 = cljs.core.seq(features);
var chunk__14166 = null;
var count__14167 = (0);
var i__14168 = (0);
while(true){
if((i__14168 < count__14167)){
var feature = chunk__14166.cljs$core$IIndexed$_nth$arity$2(null,i__14168);
...
var G__14261 = seq__14165;
var G__14262 = chunk__14166;
var G__14263 = count__14167;
var G__14264 = (i__14168 + (1));
seq__14165 = G__14261;
chunk__14166 = G__14262;
count__14167 = G__14263;
i__14168 = G__14264;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__14165);
if(temp__5804__auto__){
var seq__14165__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__14165__$1)){
var c__5565__auto__ = cljs.core.chunk_first(seq__14165__$1);
var G__14265 = cljs.core.chunk_rest(seq__14165__$1);
var G__14266 = c__5565__auto__;
var G__14267 = cljs.core.count(c__5565__auto__);
var G__14268 = (0);
seq__14165 = G__14265;
chunk__14166 = G__14266;
count__14167 = G__14267;
i__14168 = G__14268;
continue;
} else {
var feature = cljs.core.first(seq__14165__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__14269 = cljs.core.next(seq__14165__$1);
var G__14270 = null;
var G__14271 = (0);
var G__14272 = (0);
seq__14165 = G__14269;
chunk__14166 = G__14270;
count__14167 = G__14271;
i__14168 = G__14272;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5802__auto__)){
var o14197 = temp__5802__auto__;
return (o14197["version"]);
} else {
return null;
}
})() == null);
