...
while (G__15789__i < G__15789__a.length) {G__15789__a[G__15789__i] = arguments[G__15789__i + 0]; ++G__15789__i;}
  args = new cljs.core.IndexedSeq(G__15789__a,0,null);
} 
...
var or__5043__auto__ = (function (){var G__15702 = c;
var G__15702__$1 = (((G__15702 == null))?null:G__15702.constructor);
...
var G__15703 = c;
var G__15703__$1 = (((G__15703 == null))?null:G__15703.constructor);
if((G__15703__$1 == null)){
return null;
} else {
return G__15703__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__15704 = day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__15705 = c;
(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__15705);
...
}finally {(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__15704);
}});
...
var c = this;
var G__15767_15796 = day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__15767_15796 == null)){
} else {
day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.dispose_BANG_(G__15767_15796);
}
...
var renders_15797 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_15798 = cljs.core.first(cljs.core.vals(renders_15797));
...
if((cljs.core.count(renders_15797) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_15797))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_15798)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_15798], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__15779 = o;
day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.impl.component.goog$module$goog$object.set(G__15779,cljs.core.name(k),v);
...
while (G__15802__i < G__15802__a.length) {G__15802__a[G__15802__i] = arguments[G__15802__i + 0]; ++G__15802__i;}
  args = new cljs.core.IndexedSeq(G__15802__a,0,null);
} 
return G__15800__delegate.call(this,args);};
G__15800.cljs$lang$maxFixedArity = 0;
G__15800.cljs$lang$applyTo = (function (arglist__15803){
...
var _STAR_current_component_STAR__orig_val__15780 = day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__15781 = c;
(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__15781);
...
}finally {(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__15780);
}});
...
var vec__15782 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15782,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15782,(1),null);
...
var G__15785 = day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__15785 == null)){
return null;
} else {
return day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.dispose_BANG_(G__15785);
}
});
}),[]);
